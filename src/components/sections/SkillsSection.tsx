...
function SkillsSection() {
  ...
  return (
    <div className="flex flex-col items-center text-white mt-28">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between w-full max-w-7xl mb-24">
      ...
      <div className="flex flex-col lg:flex-row justify-between w-full max-w-7xl mb-24">
        <div className="text-2xl font-bold text-center">
          <p className="">Tools</p>
        </div>
        <div className="lg:-mt-2">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-4 place-items-center">
